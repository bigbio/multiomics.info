<template>
    <div style="margin-top: -15px">
      <mdb-edge-header color="#fafafa grey lighten-5">
      ...
      <mdb-container class="free-bird">
        <mdb-row>
          <mdb-col md="10" class="mx-auto white z-depth-1 py-2 px-2">
            <mdb-card-body>
              <h2 class="pb-4" align="center"><strong>Multiomics Data Portal</strong></h2>
              <mdb-row>
                <mdb-col md="3">
                  <img src="../../src/assets/logo-mdb-vue-small.png" class="img-fluid"/>
                </mdb-col>
                <mdb-col md="9">
                  <p class="pb-4">Collection of Multiomics Datasets and Services. The <strong>multiomics.info</strong> data portal crosslink different omics types (proteomics, genomics and metabolomics) </p>
                </mdb-col>
              </mdb-row>
      ...
      <mdb-container>
        <h2 class="text-center mt-5 font-weight-bold">What is Multiomics?</h2>
        <mdb-col md="10" class="mx-auto text-center text-muted mb-5">
          <p>Multiomics, multi-omics or integrative omics is a biological analysis approach in which the data sets are multiple "omes", such as the genome, proteome, transcriptome, epigenome, and metabolome; in other words, the use of multiple omics
            technologies to study life in a concerted way. Multiomics integrates diverse omics data to find a coherently matching geno-pheno-envirotype relationship or association.</p>
        </mdb-col>
        <mdb-row>
          <mdb-col md="4" class="mb-5">
            <mdb-card class="animated fadeInLeft">
              <mdb-card-image :src="require('@/assets/workflow-2.png')" alt="Card image cap"></mdb-card-image>
              <mdb-card-body>
                <mdb-card-title><mdb-icon icon="cubes" class="blue-text" /><strong>  Pipelines</strong></mdb-card-title>
          ...
          <mdb-col md="4" class="mb-5">
            <mdb-card class="animated fadeIn">
              <mdb-card-image :src="require('@/assets/data-vizualization.png')" alt="Card image cap"></mdb-card-image>
              <mdb-card-body>
                <mdb-card-title><mdb-icon icon="fas fa-tv" class="blue-text"/><strong>  Data Visualization</strong></mdb-card-title>
          ...
          <mdb-col md="4" class="mb-5">
            <mdb-card class="animated fadeInRight">
              <mdb-card-image :src="require('@/assets/data-registry.png')" alt="Card image cap"></mdb-card-image>
              <mdb-card-body>
                <mdb-card-title><mdb-icon icon="code" class="green-text" /><strong> Download Data</strong></mdb-card-title>
...
.home-page-background {
  ...
  height: 100%;
  /*opacity: 0.1;*/
  background: url('../assets/banner2.png') center;
